# publish-release.ps1 -- create the GitHub Release for ToolboxPanel 2.0.4
...
$tag = '2.0.4'
$zip = 'D:\code\github_repository\ToolboxPanel\dist\ToolboxPanel-2.0.4-win-x64.zip'
$bodyFile = 'D:\code\github_repository\ToolboxPanel\pack\release-body-2.0.4.md'
